...
Expectations do
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('abc', 0..2),
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('abcdefg', 4..6),
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Replace.new(Lookout::Diff::Range.new('Abcdefg', 0..0),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('Abcdefg', 1..3),
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Replace.new(Lookout::Diff::Range.new('Abcdefgh', 0..0),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('Abcdefgh', 1..3),
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('abcdefgHijklmno', 4..6),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('abcdefgHijklmno', 8..10),
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('123456789abcdefghijk', 0..0),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('123456789abcdefghijk', 2..4),
                                                                       Lookout::Diff::Range.new('1i3456789abXdhYjk', 2..4))),
          Lookout::Diff::Group.new(Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('123456789abcdefghijk', 8..10),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('123456789abcdefghijk', 12..12),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('123456789abcdefghijk', 16..16),
                                                                       Lookout::Diff::Range.new('1i3456789abXdhYjk', 13..13)),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new('123456789abcdefghijk', 18..19),
  ...
  expect [Lookout::Diff::Group.new(Lookout::Diff::Operations::Insert.new(Lookout::Diff::Range.new(%w[one two three four], 0...0),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new(%w[one two three four], 0..0),
                                   ...
                                   Lookout::Diff::Operations::Copy.new(Lookout::Diff::Range.new(%w[one two three four], 3..3),
