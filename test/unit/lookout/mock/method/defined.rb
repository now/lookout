...
Expectations do
  expect Lookout::Mock::Method::Defined do
    Lookout::Mock::Method::Defined.new(stub,
                                       ...
                                       Lookout::Mock::Method::Arguments.new).
      verify
  end
  ...
  expect Lookout::Mock::Method::Calls::Error.
    ...
    Lookout::Mock::Method::Defined.new(stub(:inspect => proc{ raise 'error' } ),
                                       :method,
                                       Lookout::Mock::Method::Calls::Exactly.new(:metod, 0),
                                       Lookout::Mock::Method::Arguments.new).
      tap{ |m| m.call }.verify
  end
  ...
  expect Lookout::Mock::Method::Calls::Error do
    Lookout::Mock::Method::Defined.new(stub,
                                       :method,
                                       Lookout::Mock::Method::Calls::Exactly.new(:method, 2),
                                       Lookout::Mock::Method::Arguments.new).
      verify
  end
  ...
  expect Lookout::Mock::Method::Calls::Error do
    Lookout::Mock::Method::Defined.new(stub,
                                       :method,
                                       Lookout::Mock::Method::Calls::Lower.new(:method, 2),
                                       Lookout::Mock::Method::Arguments.new).
      verify
  end
  ...
  expect Lookout::Mock::Method do
    Lookout::Mock::Method::Defined.new(stub,
                                       :method,
                                       Lookout::Mock::Method::Calls::Upper.new(:method, 2),
                                       Lookout::Mock::Method::Arguments.new).
      verify
  end
  ...
  expect Lookout::Mock::Method::Arguments::Error.new('stub.method(1, 2, 3): unexpected arguments: (4, 5, 6)≠(1, 2, 3)') do
    Lookout::Mock::Method::Defined.new(stub,
                                       :method,
                                       Lookout::Mock::Method::Calls::Lower.new(:method, 1),
                                       Lookout::Mock::Method::Arguments.new(1, 2, 3)).call(4, 5, 6)
  end
end
