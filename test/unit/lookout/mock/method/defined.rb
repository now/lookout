...
Expectations do
  ...
  expect Lookout::Mock::Method::Calls::TooManyError.new('stub#method: unexpected number of invocations (1 for 0)') do
    Lookout::Mock::Method::Defined.new(stub, :method, Lookout::Mock::Method::Calls.new(0..0)).call
  end

  expect Lookout::Mock::Method::Calls::TooManyError.new('Class.method: unexpected number of invocations (1 for 0)') do
    Lookout::Mock::Method::Defined.new(Class, :method, Lookout::Mock::Method::Calls.new(0..0)).call
  end
  ...
  expect Lookout::Mock::Method::Calls::TooManyError do
    Lookout::Mock::Method::Defined.new(stub, :method, Lookout::Mock::Method::Calls.new(0..1)).tap{ |m| 2.times{ m.call } }
  end
  ...
  expect Lookout::Mock::Method::Arguments::Error.new('stub#method: unexpected arguments ([]≠[1])') do
    Lookout::Mock::Method::Defined.new(stub, :method, Lookout::Mock::Method::Calls.new(1..1), 1).call
  end
end
