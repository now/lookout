...
Expectations do
  ...
  expect false do
    Lookout::Diff::Algorithm::Difflib::Position.origin('abc', 'abc').
  ...
  expect Lookout::Diff::Algorithm::Difflib::Position.
           new(Lookout::Diff::Range.new('dabcX', 4..4),
               Lookout::Diff::Algorithm::Difflib::Position::To.new('ddabcY', 5..5),
               {}) do
    Lookout::Diff::Algorithm::Difflib::Position.origin('dabcX', 'ddabcY').
  ...
  expect Lookout::Diff::Algorithm::Difflib::Position.
           new(Lookout::Diff::Range.new('dabcX', 0...0),
               Lookout::Diff::Algorithm::Difflib::Position::To.new('ddabcY', 0..0),
               {}) do
    Lookout::Diff::Algorithm::Difflib::Position.origin('dabcX', 'ddabcY').
